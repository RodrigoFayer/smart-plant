...
```
smart-plant/
├── CLAUDE.md          ← este arquivo (contexto geral)
...
| Resistores 220Ω | 20 | Proteção dos LEDs |
| Resistores 1kΩ | 10 | Divisor de tensão MQ135/LDR |
| Resistores 10kΩ | 10 | Pull-down dos botões |
